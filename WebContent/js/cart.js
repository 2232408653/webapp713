$(function() {
	...
	$('.del_d').click(function() {
			...
			$('.yes').click(function(){
				var url ='../servlet/delete-cart?product='+id;
...
//	console.log(totalPrice);
	...
	if(str.length>0){
		// var url = 'order-confirm.html';//'user!cartToOrder.htm?itemIds='+str;
		 window.location.href = "/webapp713/servlet/order-create?itemIds="+str;//连接数据传输str
	}
})

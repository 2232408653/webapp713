...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        ...
        <div id="icon_all">
            <ul id="icon_list">
                <li class="i1"><img src="../img/goods/<%=book.getIsbn() %>/detail1.jpg" /></li>
                <li class="i1"><img src="../img/goods/<%=book.getIsbn() %>/detail2.jpg" onerror="this.style.display='none'" /></li>
                <li class="i1"><img src="../img/goods/<%=book.getIsbn() %>/detail3.jpg" onerror="this.style.display='none'" /></li>
                <li class="i1"><img src="../img/goods/<%=book.getIsbn() %>/detail4.jpg" onerror="this.style.display='none'" /></li>
                <li class="li"><img src="../img/goods/<%=book.getIsbn() %>/detail5.jpg" onerror="this.style.display='none'" /></li>
            </ul>
        </div>
    </div>
    <!-- 右侧-->
    <div class="right_detail lf">
        ...
        <!-- 价格部分-->
        <div class="price">
            <div id="pro_price"><b>价格：</b><span>￥<%=book.getPrice() %></span></div>
            <div class="promise">
                <b>服务承诺：</b>
                <span>*退货补运费</span>
                <span>*30天无忧退货</span>
    ...
    <div class="left lf">
        <div class="all">
            ...
            <div id="parm">
                ...
                <ul>
                    <li><a href="#">图书编号：<%=book.getIsbn() %></a></li>
                    <li>
                    	<a href="#">图书名称：
                    ...
                    <li><a href="#">价格：￥<%=book.getPrice() %></a></li>
                    <li><a href="#">出版社：<%=book.getPress() %></a></li>
                    <li><a href="#">版次：<%=book.getEdition() %></a></li>
                    <li><a href="#">出版日期：<%=book.getPublished() %></a></li>
                    <li><a href="#">页数：<%=book.getPages() %></a></li>
                    <li>
                    	<a href="#">字数：<%=book.getWords() %></a>
                    </li>
                    <li><a href="#">包装：<%=book.getPackaging() %></a></li>
                    <li><a href="#">开本：<%=book.getFormat() %></a></li>
                    <li><a href="#">用纸：<%=book.getForm() %></a></li>
                </ul>
            </div>
            <div id="product_introduction">
                ...
                <img src="../img/goods/<%=book.getIsbn() %>/intro.jpg" alt=""/>
            </div>
...
<script>
    $(function () {
        ...
        $("#buy_now").click(function (e) {
            var num = $("#buy-num").val();
            // 后台需要的参数
            var url = "order-confirm.jsp?product=<%=book.getIsbn()%>&count="+num;
...
<script>
    ...
    $("#add_cart").click(function (e) {
        ...
        $.ajax({
            type: "post",
            url: "/webapp713/servlet/cart-add",
            data: params,
            success: function (data) {
                if (data == 'yes') {
                    alert("添加购物车成功！");
                    var url = "/webapp713/page/cart.jsp";
                    window.location.href = url;

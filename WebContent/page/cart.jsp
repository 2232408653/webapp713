...
ArrayList<CartItem> list = cartItemDao.selectByUser(user.getPhone());
%>
...
%>
		<div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id=<%=cartItems.getRid() %>>
                            <img src="../img/goods/<%=cartItems.getIsbn() %>/detail1.jpg" class="lf"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                         <%=cartItems.getTitle() %>
                              <input type="hidden" name="" value="">
                        </span>
                            <p class="col lf"><span>作者：</span><span class="color_des"><%=cartItems.getAuthor() %><input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                        <p class="pices_des"></p>
                        <p class="pices_information"><b>￥</b><span><%=cartItems.getPrice() %><input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value=<%=cartItems.getCount() %>><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information"><%=cartItems.getCount()*cartItems.getPrice() %></span>
                    </div>
                    <div class="del">

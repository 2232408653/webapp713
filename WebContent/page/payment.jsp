...
<form action="pay-success.html" method="post" id="pay_form">
    <div id="container" class="clearfix" >
        <!-- 支付订单信息-->
        <div class="pay_info">
            <b>支付金额：<i><%=n.getPayment() %>元</i></b><input type="hidden" name="payment" value="0.01"/>
            <span>支付订单：<%=n.getOrder_id() %> 收款方：<%=n.getUser_id() %></span><input type="hidden" name="orderId" />
        </div>
        <!--支付方式-->
        <div id="pay_type">
            <!-- 支付方式头-->
